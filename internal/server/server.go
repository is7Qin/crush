...
func (s *Server) installHandler() {
	...
	mux.HandleFunc("GET /v1/workspaces/{id}/tasks/resync", c.handleGetWorkspaceTasksResync)
	mux.HandleFunc("GET /v1/workspaces/{id}/tasks/{tid}", c.handleGetWorkspaceTask)
	mux.HandleFunc("GET /v1/workspaces/{id}/tasks/{tid}/output", c.handleGetWorkspaceTaskOutput)
	mux.HandleFunc("POST /v1/workspaces/{id}/tasks/{tid}/cancel", c.handlePostWorkspaceTaskCancel)
	mux.HandleFunc("POST /v1/workspaces/{id}/tasks/{tid}/messages", c.handlePostWorkspaceTaskMessages)
	mux.HandleFunc("GET /v1/workspaces/{id}/task-questions/pending", c.handleGetWorkspaceTaskQuestionsPending)
	mux.HandleFunc("POST /v1/workspaces/{id}/task-questions/answer", c.handlePostWorkspaceTaskQuestionsAnswer)
	mux.HandleFunc("POST /v1/workspaces/{id}/task-questions/cancel", c.handlePostWorkspaceTaskQuestionsCancel)
	...
	mux.HandleFunc("POST /v1/workspaces/{id}/agent/primary", c.handlePostWorkspaceAgentPrimary)
