...
// restart, or a dropped write). The synthetic injected by
// toolResultsForCalls and the persisted repair row written by
// healOrphanedToolCalls share it so the UI row and the model see the
// same story.
