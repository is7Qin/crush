...
func (c *Commands) defaultCommands() []*CommandItem {
	...
	if c.hasSession {
		...
		commands = append(commands, NewCommandItem(c.com.Styles, "subagents", "Subagents", "ctrl+b", ActionOpenDialog{DialogID: SubagentsID}).WithAliases("sub agents", "child tasks"))
	}
